...
am_rel_srcdir='.'
am_top_srcdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/build/host-automake-1.15'
am_top_builddir='/home/dean/sunxi-v3s/buildroot-2017.08/output/build/host-automake-1.15'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/automake-1.15/am'
    am_automake_acdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/aclocal-1.15'
    am_bindir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/bin'
    am_datadir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share'
    am_docdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/doc/automake'
    am_pkgvdatadir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/automake-1.15'
    am_scriptdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/automake-1.15'
    am_system_acdir='/home/dean/sunxi-v3s/buildroot-2017.08/output/host/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/dean/sunxi-v3s/buildroot-2017.08/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/dean/sunxi-v3s/buildroot-2017.08/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/dean/sunxi-v3s/buildroot-2017.08/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/dean/sunxi-v3s/buildroot-2017.08/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/dean/sunxi-v3s/buildroot-2017.08/output/host/include'}}
